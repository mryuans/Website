...
var createObserversSetup = (t2, n2, o2, s2) => {
  ...
  const { dt: g3, vt: h2, L: b2, gt: w2, ht: y2, V: S2, bt: m2, wt: O2, yt: C2, St: $2 } = t2;
  ...
  const [z2] = createCache({
    ...
    const s3 = E2 && E2.R(t2, n2, x3, H2, o2).Y;
    const e3 = m2 && S2;
  ...
  return [() => {
    ...
    const [g4, h3] = t3("update.elementEvents");
...
var createScrollbarsSetupElements = (t2, n2, o2, s2) => {
  ...
  const { slot: a2 } = l2;
  const { dt: u2, vt: f2, L: _2, Tt: d2, gt: v2, bt: g3, V: h2 } = n2;
  const { scrollbars: b2 } = d2 ? {} : t2;
  const { slot: w2 } = b2 || {};
  const y2 = [];
  const S2 = [];
  const m2 = [];
  const O2 = dynamicInitializationElement([u2, f2, _2], (() => h2 && g3 ? u2 : f2), a2, w2);
...
var createScrollbarsSetupEvents = (t2, n2, o2, s2) => (r2, i2, l2) => {
  ...
  const createInteractiveScrollEvents = () => {
    ...
    return addEventListener(h2, "pointerdown", ((o3) => {
      ...
      const w3 = g4[l3 ? "dragScroll" : "clickScroll"];
      const { button: y3, isPrimary: O3, pointerType: C2 } = o3;
      const { pointers: $2 } = g4;
      const x3 = y3 === 0 && O3 && w3 && ($2 || []).includes(C2);
      if (x3) {
        runEachAndClear(f3);
        m2();
        ...
        const H2 = y4();
        const E2 = x4[r3];
        const z2 = getHandleOffset(x4, H2) + E2 / 2;
        const I2 = $3 - H2[i3];
        const T2 = l3 ? 0 : I2 - z2;
...
var createScrollbarsSetup = (t2, n2, o2, s2, e2, c2) => {
  ...
  return [() => bind(runEachAndClear, push(M2, O2())), ({ zt: t3, At: n3, Qt: e3, Zt: c3 }) => {
    ...
    const [P3, N2] = t3("scrollbars.autoHide");
...
var createPaddingUpdateSegment = ({ vt: t2, rn: n2, L: o2, V: s2 }, e2) => {
  ...
  return ({ zt: t3, Qt: i2, un: l2, At: a2 }) => {
    ...
    const { B: O2 } = l2;
    const [$2, x3] = t3("paddingAbsolute");
    const H2 = a2 || p2;
    if (d2 || f2 || H2) {
      [u2, f2] = c2(a2);
    }
    const E2 = !s2 && (x3 || m2 || f2);
    if (E2) {
      const t4 = !$2 || !n2 && !_2;
      const s3 = u2.r + u2.l;
      const c3 = u2.t + u2.b;
...
var createOverflowUpdateSegment = (t2, s2) => {
  ...
  const getMeasuredScrollCoordinates = (t3, n2) => {
    ...
    const m3 = {
      x: c(h3.x) >= c(S3.x) ? g4.x : b3.x,
      y: c(h3.y) >= c(S3.y) ? g4.y : b3.y
    };
  ...
  return ({ zt: n2, Qt: o2, un: c2, At: l2 }, { _n: u3 }) => {
    ...
    const [bt2, wt2] = ht2 ? U2(getMeasuredScrollCoordinates(vt2, !!pt2), l2) : P3();
...
var createSetups = (t2, n2, o2, s2, e2) => {
  ...
  const [v2, g3, , h2] = createScrollbarsSetup(t2, n2, p2, a2, u2, e2);
...
var OverlayScrollbars = (t2, n2, o2) => {
  ...
  if (n2 && !r2) {
    ...
    const [g3, h2, b2, w2, y2] = createSetups(t2, a2, (() => r3), (({ dn: t3, At: n3 }, { Qt: o3, Zt: s3 }) => {
