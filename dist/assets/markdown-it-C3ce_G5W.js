import{A as v}from"./Anchor-DS2pFRhX.js";import{_ as u}from"./BlockCode.vue_vue_type_script_setup_true_lang-B3B-JMei.js";import{_ as f}from"./Delimiter.vue_vue_type_script_setup_true_lang-CzbbvmBW.js";import{_ as l}from"./Fold.vue_vue_type_style_index_0_lang-D0QQ0TGC.js";import{_ as M}from"./Grid.vue_vue_type_style_index_0_lang-DvJN5rvR.js";import{H as i}from"./Heading-hjZtCiuH.js";import{d as I,B as E,o as r,e as T,a as t,a6 as $,u as e,w as p,f as s,r as S,c as w,t as o,_ as W,b as a,F as c,p as O}from"./index-CnQXsKRk.js";import"./animate-height-r1_3K2_X.js";import"./vendor-katex-BDPLvt6s.js";const D={class:"linkcard"},F={class:"content"},G={class:"item title"},P={class:"item link"},V={class:"icon"},L={class:"href"},N={class:"logo"},J=I({__name:"LinkCard",props:{href:{}},setup(d){const m=d,g=/^https?:\/\/|^\/assets\//.test(m.href),y=/github\.com/.test(m.href);return(x,b)=>{const k=E("font-awesome-icon");return r(),T("div",D,[t($,{src:d.href,mode:e(g)?"jump":"stay"},{default:p(()=>[s("div",F,[s("div",G,[S(x.$slots,"default",{},void 0,!0)]),s("div",P,[s("span",V,[e(g)?(r(),w(k,{key:0,icon:["fas","arrow-up-right-from-square"]})):(r(),w(k,{key:1,icon:["far","star"]}))]),s("span",L,o(d.href),1)])]),s("div",N,[e(y)?(r(),w(k,{key:0,icon:["fab","github"]})):(r(),w(k,{key:1,icon:["fas","link"]}))])]),_:3},8,["src","mode"])])}}}),z=W(J,[["__scopeId","data-v-0f2cf9e8"]]),K={class:"quote"},Q=`<code class="language-markdown"><span class="token title important"><span class="token punctuation">#</span> Hello **World** // 整一个结构而不关注加粗逻辑</span>
